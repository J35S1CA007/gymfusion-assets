...
#gfLoader .gf-backdrop-image{position:absolute;inset:0;z-index:1;pointer-events:none;opacity:0;transition:opacity 700ms ease;background:
...
@media (max-width:640px){#gfLoader{grid-template-rows:minmax(150px,30vh) 1fr auto}#gfLoader.gf-galaxy-loaded .gf-backdrop{opacity:0}#gfLoader .gf-backdrop-image{background-size:auto,100% auto;background-position:center,center top}.gf-brand{width:min(82vw,330px)}#gfLoader .gf-emblem{width:64px!important;height:64px!important;margin:48px auto -30px!important}.gf-logo{width:min(68vw,270px)}#gfLoader.gf-loader-standard-page .gf-wheel,#gfLoader.gf-loader-embed-page .gf-wheel{width:62px;height:62px;border-width:3px;animation-duration:1.65s;box-shadow:0 0 0 1px rgba(255,255,255,0.05),0 0 18px rgba(143,57,255,0.22)}#gfLoader.gf-loader-standard-page .gf-progress,#gfLoader.gf-loader-embed-page .gf-progress{height:7px;opacity:0.82}#gfLoader.gf-loader-standard-page .gf-progress-fill,#gfLoader.gf-loader-embed-page .gf-progress-fill{background:linear-gradient(90deg,#7000F7 0%,#9B00FF 15%,#C500D6 30%,#ED007A 50%,#FF0045 68%,#FF4A1C 82%,#FF7A00 92%,#FFA000 100%);box-shadow:0 0 18px rgba(162,48,255,0.58),0 0 28px rgba(255,74,28,0.34)}#gfLoader.gf-loader-standard-page .gf-loading,#gfLoader.gf-loader-embed-page .gf-loading{text-shadow:0 8px 20px rgba(0,0,0,0.72)}.gf-loading{max-width:82vw;font-size:17px;letter-spacing:0.07em}.gf-loading-word{margin-left:0.18em}.gf-center{transform:translateY(-6vh)}}
`;
